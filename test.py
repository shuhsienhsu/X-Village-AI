...
# In order to know the effect of changing gamma's value, I used training data to test the model:
expected_test = digits.target[:n_samples // 2]
predicted_test = classifier.predict(data[:n_samples // 2])
